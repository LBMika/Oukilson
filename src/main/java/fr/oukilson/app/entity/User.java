...
public class User {
    ...
    private List<GameOld> userGameList;
    private List<GameOld> userLikeList;
     ...
     */
    public List<GameOld> getUserGameList() {
        return userGameList;
    }
     ...
     */
    public void setUserGameList(List<GameOld> userGameList) {
     ...
     */
    public List<GameOld> getUserLikeList() {
        return userLikeList;
    }
     ...
     */
    public void setUserLikeList(List<GameOld> userLikeList) {
